...
export const DATA = {
  ...
  description:
    "Full Stack Developer having a strong foundation in web technologies, build many website's with responsive design, user friendly interface, payment integration and many features",
  summary:
    "",
